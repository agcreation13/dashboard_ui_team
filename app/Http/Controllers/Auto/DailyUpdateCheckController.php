...
use App\Services\DailyUpdateChecker;
...
class DailyUpdateCheckController extends Controller
{
    /**
     * Check and update leads and sites status based on follow-ups and daily entries
     * 
     * @return \Illuminate\Http\RedirectResponse
     */
    public function checkUpdaterun()
    {
    $checker = new DailyUpdateChecker();
    $checker->checkUpdaterun();
      return redirect()->back();
    }
    
    public function checkUpdaterun1()
    {
