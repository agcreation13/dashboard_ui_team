...
<div class="page-header">
    <div class="row pb-2">
        <div class="col-md-6 col-left">
            <div class="title">
                <h4>Edit GST Invoice #{{ $invoice->invoice_number }}</h4>
            </div>
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('invoices.index') }}">Invoices</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('invoices.show', $invoice->id) }}">View</a></li>
    ...
    <form action="{{ route('invoices.update', $invoice->id) }}" method="POST" id="invoiceForm">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 form-group">
                        ...
                        <input class="form-control" type="date" name="invoice_date" value="{{ old('invoice_date', $invoice->invoice_date->format('Y-m-d')) }}" required>
                        @error('invoice_date') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
                    <div class="col-md-3 form-group">
                        <label>E-way Bill</label>
                        <input class="form-control" type="text" name="eway_bill" value="{{ old('eway_bill', $invoice->eway_bill) }}" placeholder="E-way Bill">
                        @error('eway_bill') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
                    <div class="col-md-3 form-group">
                        <label>MR NO.</label>
                        <input class="form-control" type="text" name="mr_no" value="{{ old('mr_no', $invoice->mr_no) }}" placeholder="MR NO">
                        @error('mr_no') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>
                    <div class="col-md-3 form-group">
                        <label>S. MAN</label>
                        <input class="form-control" type="text" name="s_man" value="{{ old('s_man', $invoice->s_man) }}" placeholder="S. MAN">
        ...
        <!-- Buyer/Customer Details (Read Only) -->
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="dw dw-user"></i> Buyer/Customer Details <small class="text-muted">(Read Only)</small></h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input class="form-control" type="text" value="{{ $invoice->customer->name ?? $invoice->customer_name }}" readonly style="background-color: #f8f9fa;">
                    </div>
                    <div class="col-md-6 form-group">
                        <label class="font-weight-bold">Customer Name</label>
                        <input type="hidden" name="customer_name" value="{{ $invoice->customer_name }}">
                        <input class="form-control" type="text" value="{{ $invoice->customer_name }}" readonly style="background-color: #f8f9fa;">
                    </div>
                    <div class="col-md-6 form-group">
                        <label class="font-weight-bold">Customer Mobile</label>
                        <input type="hidden" name="customer_mobile" value="{{ $invoice->customer_mobile }}">
                        <input class="form-control" type="text" value="{{ $invoice->customer_mobile }}" readonly style="background-color: #f8f9fa;">
                    </div>
                    <div class="col-md-6 form-group">
                        <label class="font-weight-bold">Customer Email</label>
                        <input type="hidden" name="customer_email" value="{{ $invoice->customer_email }}">
                        <input class="form-control" type="email" value="{{ $invoice->customer_email }}" readonly style="background-color: #f8f9fa;">
                    </div>
                    <div class="col-md-6 form-group">
                        <label class="font-weight-bold">Customer GSTIN</label>
                        <input type="hidden" name="customer_gstin" value="{{ $invoice->customer_gstin }}">
                        <input class="form-control" type="text" value="{{ $invoice->customer_gstin }}" readonly style="background-color: #f8f9fa;">
                    </div>
                    <div class="col-md-6 form-group">
                        <label class="font-weight-bold">State</label>
                        <input type="hidden" name="customer_state" value="{{ $invoice->customer_state }}">
                        <input class="form-control" type="text" value="{{ $invoice->customer_state }}" readonly style="background-color: #f8f9fa;">
                    </div>
                    <div class="col-md-12 form-group">
                        ...
                        <textarea class="form-control" rows="2" readonly style="background-color: #f8f9fa;">{{ $invoice->customer_address }}</textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive" style="max-height: 500px; overflow-x: auto; overflow-y: auto;">
                    <table class="table table-bordered table-hover mb-0" id="items-table" style="font-size: 13px; min-width: 1400px;">
                        ...
                        <tbody id="items-container">
                            ...
                            <tr class="item-row">
                                <td class="sr-no align-middle" style="vertical-align: middle;">{{ $index + 1 }}</td>
                                <td>
                                    <select name="items[{{ $index }}][product_id]" class="form-control form-control-sm product-select" required style="border: 1px solid #ddd; width: 100%; font-size: 12px;">
                                    ...
                                    <option value="{{ $product->id }}" 
                                        ...
                                        data-gst="{{ $product->gst_percentage ?? 0 }}"
                                        {{ $item->product_id == $product->id ? 'selected' : '' }}>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                    <input type="hidden" name="items[{{ $index }}][hsn]" class="hsn-field" value="{{ $item->hsn ?? '' }}">
                                </td>
                                <td><input type="text" name="items[{{ $index }}][pack]" class="form-control form-control-sm pack" value="{{ $item->pack ?? '' }}" placeholder="PACK" style="border: 1px solid #ddd; width: 100%; font-size: 12px;"></td>
                                <td><input type="number" name="items[{{ $index }}][quantity]" class="form-control form-control-sm quantity" value="{{ $item->quantity }}" placeholder="Qty" min="1" required style="border: 1px solid #ddd; width: 100%; font-size: 12px; font-weight: 500;"></td>
                                <td><input type="number" name="items[{{ $index }}][free_quantity]" class="form-control form-control-sm free-qty" value="{{ $item->free_quantity ?? 0 }}" placeholder="Free" min="0" style="border: 1px solid #ddd; width: 100%; font-size: 12px;"></td>
                                <td><input type="number" step="0.01" name="items[{{ $index }}][mrp]" class="form-control form-control-sm mrp" value="{{ $item->mrp ?? 0 }}" placeholder="MRP" min="0" style="border: 1px solid #ddd; width: 100%; font-size: 12px;"></td>
                                <td><input type="number" step="0.01" name="items[{{ $index }}][rate]" class="form-control form-control-sm rate" value="{{ $item->rate }}" placeholder="Rate" min="0" required style="border: 1px solid #ddd; width: 100%; font-size: 12px; font-weight: 500;"></td>
                                <td><input type="number" step="0.01" name="items[{{ $index }}][discount_percentage]" class="form-control form-control-sm discount-pct" value="{{ $item->discount_percentage ?? 0 }}" placeholder="DIS%" min="0" style="border: 1px solid #ddd; width: 100%; font-size: 12px;"></td>
                                <td><input type="number" step="0.01" name="items[{{ $index }}][gst_percentage]" class="form-control form-control-sm gst-pct" value="{{ $item->gst_percentage ?? 0 }}" placeholder="GST%" min="0" style="border: 1px solid #ddd; width: 100%; font-size: 12px; font-weight: 500;"></td>
                                <td><input type="number" step="0.01" name="items[{{ $index }}][gst_amount]" class="form-control form-control-sm gst-amt" value="{{ $item->gst_amount ?? 0 }}" placeholder="G.AMT" min="0" readonly style="border: 1px solid #ddd; background-color: #f8f9fa; width: 100%; font-size: 12px;"></td>
                                <td><input type="number" step="0.01" name="items[{{ $index }}][net_amount]" class="form-control form-control-sm net-amt" value="{{ $item->net_amount ?? 0 }}" placeholder="NET AMT" min="0" readonly style="border: 1px solid #ddd; background-color: #f8f9fa; font-weight: bold; width: 100%; font-size: 12px; color: #28a745;"></td>
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="subtotal" id="subtotal" class="form-control" readonly value="{{ old('subtotal', $invoice->subtotal) }}" style="font-weight: bold; background-color: #f8f9fa;">
                        </div>
                        <div class="form-group">
                            <label>Additional</label>
                            <input type="number" step="0.01" name="additional_amount" id="additional_amount" class="form-control" value="{{ old('additional_amount', $invoice->additional_amount ?? 0) }}" min="0" placeholder="0.00">
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>CGST %</label>
                                <input type="number" step="0.01" name="cgst_percentage" id="cgst_percentage" class="form-control" value="{{ old('cgst_percentage', $invoice->cgst_percentage ?? 0) }}" min="0" max="100" placeholder="0.00">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>CGST Amount</label>
                                <input type="number" step="0.01" name="cgst_amount" id="cgst_amount" class="form-control" readonly value="{{ old('cgst_amount', $invoice->cgst_amount ?? 0) }}" style="background-color: #f8f9fa;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>SGST %</label>
                                <input type="number" step="0.01" name="sgst_percentage" id="sgst_percentage" class="form-control" value="{{ old('sgst_percentage', $invoice->sgst_percentage ?? 0) }}" min="0" max="100" placeholder="0.00">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>SGST Amount</label>
                                <input type="number" step="0.01" name="sgst_amount" id="sgst_amount" class="form-control" readonly value="{{ old('sgst_amount', $invoice->sgst_amount ?? 0) }}" style="background-color: #f8f9fa;">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Round Off</label>
                            <input type="number" step="0.01" name="round_off" id="round_off" class="form-control" readonly value="{{ old('round_off', $invoice->round_off ?? 0) }}" style="background-color: #f8f9fa;">
                        </div>
                        <div class="form-group">
                            <label style="font-size: 16px; font-weight: 600;">Grand Total</label>
                            <input type="number" step="0.01" name="grand_total" id="grand_total" class="form-control" readonly value="{{ old('grand_total', $invoice->grand_total) }}" style="font-weight: bold; font-size: 18px; background-color: #e7f3ff; border: 2px solid #4a90e2;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-3 text-right">
            <button type="submit" class="btn btn-primary btn-sm mr-2" style="font-size: 14px; font-weight: 500; min-width: 100px; padding: 8px 20px;"><i class="dw dw-check"></i> Update</button>
            <a href="{{ route('invoices.show', $invoice->id) }}" class="btn btn-secondary btn-sm" style="font-size: 14px; font-weight: 500; min-width: 100px; padding: 8px 20px;"><i class="dw dw-cancel"></i> Cancel</a>
        </div>
    </form>
</div>
...
// Customer fields are read-only in edit mode, no auto-fill needed
...
document.getElementById('add-item').addEventListener('click', function() {
    ...
    if (!templateRow) {
        alert('No template row found. Please refresh the page.');
        return;
    }
    ...
    newRow.querySelectorAll('input, select').forEach(input => {
        if (input.name) {
            // Get the current index from name (e.g., items[0][product_id] -> items[1][product_id])
...
attachEventListeners();
// Calculate totals on page load to ensure all values are set
setTimeout(function() {
    calculateTotal();
}, 100);
</script>
