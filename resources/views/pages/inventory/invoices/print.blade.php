...
<body>
    <div class="no-print">
        <button onclick="window.print()" class="btn btn-primary btn-sm mr-2" style="font-size: 14px; font-weight: 500; min-width: 100px; padding: 8px 20px;">Print</button>
        <button onclick="window.close()" class="btn btn-secondary btn-sm" style="font-size: 14px; font-weight: 500; min-width: 100px; padding: 8px 20px;">Close</button>
    </div>
    ...
    <div class="gst-invoice-title text-center">{{ $invoice->status === 'cancelled' ? 'CANCELLED INVOICE' : 'INVOICE' }}</div>
     ...
     <hr style="margin-top: 10px; margin-bottom: 10px; border: 1px dashed #000;">
    <!-- Second Invoice (Bottom) -->
    <div class="invoice-container">
        <div class="gst-invoice-title text-center">{{ $invoice->status === 'cancelled' ? 'CANCELLED INVOICE' : 'INVOICE' }}</div>
