...
<div class="page-header">
    ...
    <form action="{{ route('labourRoles.Update', $labourRoles->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <input class="form-control" type="text" name="name" value="{{ old('name', $labourRoles->name) }}" required placeholder="Role Title">
                @error('name')
